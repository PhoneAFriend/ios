...
class ContactTableViewController : UITableViewController {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let startSession = UIAlertAction(title: "Start Session", style: .Default, handler: { (action: UIAlertAction) in
            ...
            let sessionRefString = Session.create(self.contactToPass, postRef: "")
            
            // Call through Twilio
            twilioClient!.dialUser(self, contactName: self.contactToPass, sessionRefString: sessionRefString)
        })
